...
public class Controlador implements Initializable, Closeable {
    ...
    private boolean cadastroValido(){
        boolean nomeValido = verificacoes.verificarNome(dataBase, nome);
        boolean emailValido = verificacoes.verificarEmail(dataBase, email);
        boolean dataValida = verificacoes.verificarDataDeNascimento(dataDeNascimento);
        boolean senhaValida = verificacoes.verificarSenha(senha, confirmarSenha);
